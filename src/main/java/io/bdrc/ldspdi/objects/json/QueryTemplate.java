...
public class QueryTemplate {
    ...
    public QueryTemplate(String id, String domain, String demoLink, String queryScope, String queryResults, String queryReturn, String queryParams,
            String queryOptParams, ArrayList<Param> params, ArrayList<Output> outputs, String template) {
        super();
        this.id = id;
        this.domain = domain;
        ...
        this.queryOptionalParams = queryOptParams;
        this.params = params;
    ...
    public String getQueryOptParams() {
        return queryOptionalParams;
    }
