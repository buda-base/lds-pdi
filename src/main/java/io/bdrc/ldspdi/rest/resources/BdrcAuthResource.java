...
public class BdrcAuthResource {
    ...
    public Response getAuthModel(@Context Request request) throws RestException {
        ...
        ResponseBuilder builder = Response.ok(ResponseOutputStream.getModelStream(QueryProcessor.getAuthGraph(fusekiUrl, "authDataGraph")), MediaTypeUtils.getMimeFromExtension("ttl"));
        builder = setLastModified(builder);
        return builder.build();
    }
