...
public class TTLRDFWriter {
    ...
    static {
        ...
        predicatesPrio.add("http://purl.bdrc.io/ontology/seqNum");
        predicatesPrio.add("http://purl.bdrc.io/ontology/onYear");
        predicatesPrio.add("http://purl.bdrc.io/ontology/notBefore");
        predicatesPrio.add("http://purl.bdrc.io/ontology/notAfter");
        predicatesPrio.add("http://purl.bdrc.io/ontology/noteText");
        predicatesPrio.add("http://purl.bdrc.io/ontology/noteWork");
        predicatesPrio.add("http://purl.bdrc.io/ontology/noteLocationStatement");
        predicatesPrio.add("http://purl.bdrc.io/ontology/volumeNumber");
        predicatesPrio.add("http://purl.bdrc.io/ontology/workSitePlace");
        predicatesPrio.add("http://purl.bdrc.io/ontology/lineageWho");
